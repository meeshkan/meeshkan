...
export type IntegrationUpdateByFilterInput = {
  continuousIntegrationProvider?: Maybe<Array<Maybe<UpdateByFilterStringSwitchInput>>>;
  projectManagementProvider?: Maybe<Array<Maybe<UpdateByFilterStringSwitchInput>>>;
};
