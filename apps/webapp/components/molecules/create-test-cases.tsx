...
export const CreateTestCases = ({ projectID }: { projectID: string }) => {
			...
			{radio === 'Manually' && (
				<Box maxW="650px">
					...
					<Text>
						...
						This is is great if you are a developer or product manager testing a
						new feature where user behavior is still unknown but you'd like to
